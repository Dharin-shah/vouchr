...
| `VOUCHR_LOCKDOWN` | yes | yes | #239 containment: set per plane during an incident — readiness 503 + serving/refresh/callback-write/resolver/setup and built-in Slack installation reads/writes denied before secret access; break-glass deletion still works. Authority is this env, never a DB flag |
